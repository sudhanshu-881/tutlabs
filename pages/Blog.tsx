...
const Blog: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-10">
      ...
      {/* Table of Contents */}
      <aside className="bg-white/80 dark:bg-gray-900/70 backdrop-blur rounded-xl border border-white/20 dark:border-white/10 p-4">
      ...
      <div className="space-y-6">
        {pagePosts.map((p) => {
          ...
          return (
            <article key={p.id} id={p.id} className="bg-white/80 dark:bg-gray-900/70 backdrop-blur rounded-2xl shadow border border-white/20 dark:border-white/10 p-6">
