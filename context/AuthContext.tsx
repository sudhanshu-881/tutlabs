...
// Credentials are now loaded from environment variables. This is a critical security measure
// to prevent exposing sensitive keys in the client-side source code.
//
// In your hosting environment (e.g., Netlify, Vercel, or a custom server), you must set the following
...
if (supabaseUrl && supabaseAnonKey) {
  ...
  console.warn("Supabase URL and Anon Key are not set as environment variables. Please set SUPABASE_URL and SUPABASE_ANON_KEY to connect to your Supabase project. Authentication features will be disabled.");
}
