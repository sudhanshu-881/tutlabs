      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-blue-600 dark:text-blue-500">tutLabs</h2>
            ...
            <div className="flex space-x-4">
                <a href="#" className="text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 transition-transform duration-300 hover:scale-110 hover:-translate-y-1"><ion-icon name="logo-facebook" className="text-2xl"></ion-icon></a>
                <a href="#" className="text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 transition-transform duration-300 hover:scale-110 hover:-translate-y-1"><ion-icon name="logo-twitter" className="text-2xl"></ion-icon></a>
                <a href="#" className="text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 transition-transform duration-300 hover:scale-110 hover:-translate-y-1"><ion-icon name="logo-instagram" className="text-2xl"></ion-icon></a>
                <a href="#" className="text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 transition-transform duration-300 hover:scale-110 hover:-translate-y-1"><ion-icon name="logo-linkedin" className="text-2xl"></ion-icon></a>
            </div>
          </div>
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><Link to="/tutors" className="text-base text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Find Tutors</Link></li>
              <li><Link to="/students" className="text-base text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Find Students</Link></li>
            </ul>
          </div>
          <div>
